...
(function(global, factory) {
    ...
    function(exports, $, Popper) {
        ...
        $(document).on(Event$1.CLICK_DATA_API,
            ...
            }).on(Event$1.FOCUS_BLUR_DATA_API,
            Selector$1.DATA_TOGGLE_CARROT,
            function(event) {
            ...
            function() {
                ...
                _proto._addEventListeners = function _addEventListeners() {
                    ...
                    if (this._config.keyboard) {
                        $(this._element).on(Event$2.KEYDOWN,
                            function(event) {
                    ...
                    if (this._config.pause === 'hover') {
                        $(this._element).on(Event$2.MOUSEENTER,
                            function(event) {
                                return _this2.pause(event);
                            }).on(Event$2.MOUSELEAVE,
                            function(event) {
                ...
                _proto._addTouchEventListeners = function _addTouchEventListeners() {
                    ...
                    $(this._element.querySelectorAll(Selector$2.ITEM_IMG)).on(Event$2.DRAG_START,
                        function(e) {
                            return e.preventDefault();
                        });

                    if (this._pointerEvent) {
                        $(this._element).on(Event$2.POINTERDOWN,
                            function(event) {
                                return start(event);
                            });
                        $(this._element).on(Event$2.POINTERUP,
                            function(event) {
                                return end(event);
                            });
                        ...
                        $(this._element).on(Event$2.TOUCHSTART,
                            function(event) {
                                return start(event);
                            });
                        $(this._element).on(Event$2.TOUCHMOVE,
                            function(event) {
                                return move(event);
                            });
                        $(this._element).on(Event$2.TOUCHEND,
                            function(event) {
                                return end(event);
                            });
                    }
            ...
            function() {
                ...
                _proto.show = function show() {
                    ...
                    var complete = function complete() {
                        $(_this._element).removeClass(ClassName$3.COLLAPSING).addClass(ClassName$3.COLLAPSE)
                ...
                _proto.hide = function hide() {
                    ...
                    $(this._element).addClass(ClassName$3.COLLAPSING).removeClass(ClassName$3.COLLAPSE)
                    ...
                    var complete = function complete() {
                        ...
                        $(_this2._element).removeClass(ClassName$3.COLLAPSING).addClass(ClassName$3.COLLAPSE)
        ...
        $(document).on(Event$3.CLICK_DATA_API,
        ...
        var Dropdown =
            ...
            function() {
                ...
                _proto._addEventListeners = function _addEventListeners() {
                    ...
                    $(this._element).on(Event$4.CLICK,
                        function(event) {
                            event.preventDefault();
        ...
        $(document).on(Event$4.KEYDOWN_DATA_API, Selector$4.DATA_TOGGLE, Dropdown._dataApiKeydownHandler)
            ...
            .on(Event$4.CLICK_DATA_API + " " + Event$4.KEYUP_DATA_API, Dropdown._clearMenus).on(Event$4.CLICK_DATA_API,
        ...
        var Modal =
            ...
            function() {
                ...
                _proto.show = function show(relatedTarget) {
                    ...
                    $(this._element).on(Event$5.CLICK_DISMISS,
                    ...
                    $(this._dialog).on(Event$5.MOUSEDOWN_DISMISS,
                        function() {
                            $(_this._element).one(Event$5.MOUSEUP_DISMISS,
                                function(event) {
                ...
                _proto._setEscapeEvent = function _setEscapeEvent() {
                    ...
                    if (this._isShown && this._config.keyboard) {
                        $(this._element).on(Event$5.KEYDOWN_DISMISS,
                            function(event) {
                ...
                _proto._setScrollbar = function _setScrollbar() {
                    ...
                    if (this._isBodyOverflowing) {
                        ...
                        var stickyContent =
                            [].slice.call(
                                document.querySelectorAll(Selector$5.STICKY_CONTENT)); // Adjust fixed content padding
        ...
        $(document).on(Event$5.CLICK_DATA_API,
            ...
            function(event) {
                ...
                var $target = $(target).one(Event$5.SHOW,
                    function(showEvent) {
                        if (showEvent.isDefaultPrevented()) {
            ...
            function() {
                ...
                _proto._setListeners = function _setListeners() {
                    ...
                    triggers.forEach(function(trigger) {
                        if (trigger === 'click') {
                            $(_this4.element).on(_this4.constructor.Event.CLICK,
        ...
        var ScrollSpy =
            ...
            function() {
                function ScrollSpy(element, config) {
                    ...
                    $(this._scrollElement).on(Event$8.SCROLL,
                        function(event) {
                ...
                _proto._activate = function _activate(target) {
                    ...
                    if ($link.hasClass(ClassName$8.DROPDOWN_ITEM)) {
                        $link.closest(Selector$8.DROPDOWN).find(Selector$8.DROPDOWN_TOGGLE)
                        ...
                        $link.parents(Selector$8.NAV_LIST_GROUP).prev(Selector$8.NAV_ITEMS)
                            .children(Selector$8.NAV_LINKS).addClass(ClassName$8.ACTIVE);
                    }
            ...
            function() {
                ...
                _proto._activate = function _activate(element, container, callback) {
                    ...
                    if (active && isTransitioning) {
                        ...
                        $(active).removeClass(ClassName$9.SHOW).one(Util.TRANSITION_END, complete)
                            .emulateTransitionEnd(transitionDuration);
                    } else {
                        complete();
                    }
                        ...
                        if (element.parentNode && $(element.parentNode).hasClass(ClassName$9.DROPDOWN_MENU)) {
                            ...
                            if (dropdownElement) {
                                var dropdownToggleList =
                                    [].slice.call(dropdownElement.querySelectorAll(Selector$9.DROPDOWN_TOGGLE));
        ...
        $(document).on(Event$9.CLICK_DATA_API,
        ...
        var Toast =
            ...
            function() {
                ...
                _proto._setListeners = function _setListeners() {
                    ...
                    $(this._element).on(Event$a.CLICK_DISMISS,
